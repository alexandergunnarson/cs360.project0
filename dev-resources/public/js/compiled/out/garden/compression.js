 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__31276){
var vec__31278 = p__31276;
var tag = cljs.core.nth.call(null,vec__31278,(0),null);
var re = cljs.core.nth.call(null,vec__31278,(1),null);
return ((function (vec__31278,tag,re){
return (function (s){
...
var len__18583__auto___31281 = arguments.length;
var i__18584__auto___31282 = (0);
while(true){
if((i__18584__auto___31282 < len__18583__auto___31281)){
args__18590__auto__.push((arguments[i__18584__auto___31282]));

var G__31283 = (i__18584__auto___31282 + (1));
i__18584__auto___31282 = G__31283;
continue;
} else {
}
break;
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__18591__auto__);
});
...
return p1__31279_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq31280){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31280));
});
/**
...
var map__31287 = temp__4423__auto__;
...
var tag = cljs.core.get.call(null,map__31287__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__31287__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__31287__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__31290 = cljs.core.subs.call(null,s1,size);
var G__31291 = [cljs.core.str(s2),cljs.core.str((function (){var G__31289 = (((tag instanceof cljs.core.Keyword))?tag.fqn:null);
switch (G__31289) {
case "l-brace":
return "}";
...
//# sourceMappingURL=compression.js.map?rel=1452702627495