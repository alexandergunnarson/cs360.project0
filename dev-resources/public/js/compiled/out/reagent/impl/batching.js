...
var or__17525__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__17525__auto__)){
return or__17525__auto__;
} else {
var or__17525__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__17525__auto____$1)){
return or__17525__auto____$1;
} else {
var or__17525__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__17525__auto____$2)){
return or__17525__auto____$2;
} else {
var or__17525__auto____$3 = (w["msRequestAnimationFrame"]);
...
var n__18428__auto__ = a.length;
var i = (0);
while(true){
if((i < n__18428__auto__)){
var c_46793 = (a[i]);
if(cljs.core.truth_((c_46793["cljsIsDirty"]))){
(c_46793["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__18123__auto__,writer__18124__auto__,opt__18125__auto__){
return cljs.core._write.call(null,writer__18124__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__46797 = c;
var G__46797__$1 = (((G__46797 == null))?null:(G__46797["props"]));
if((G__46797__$1 == null)){
return null;
} else {
return (G__46797__$1["argv"]);
}
});
...
var G__46799_46800 = (c["cljsRatom"]);
if((G__46799_46800 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__46799_46800);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1452702581128