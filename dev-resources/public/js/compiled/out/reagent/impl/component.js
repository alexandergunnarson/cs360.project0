...
var _STAR_current_component_STAR_46805 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_46805;
}});
...
var G__46809 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__46809) {
...
var or__17525__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
return (function() { 
var G__46811__delegate = function (args){
var c = this;
...
while (G__46812__i < G__46812__a.length) {G__46812__a[G__46812__i] = arguments[G__46812__i + 0]; ++G__46812__i;}
  args = new cljs.core.IndexedSeq(G__46812__a,0);
} 
return G__46811__delegate.call(this,args);};
...
return G__46811__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__17513__auto__ = wrap;
...
var or__17525__auto__ = (function (){var and__17513__auto__ = cljs.core.fn_QMARK_.call(null,f);
if(and__17513__auto__){
var or__17525__auto__ = (f["displayName"]);
if(cljs.core.truth_(or__17525__auto__)){
return or__17525__auto__;
} else {
return (f["name"]);
...
var or__17525__auto____$1 = (function (){var and__17513__auto__ = ((!((f == null)))?((((f.cljs$lang$protocol_mask$partition1$ & (4096))) || (f.cljs$core$INamed$))?true:false):false);
if(and__17513__auto__){
...
var render_fun = (function (){var or__17525__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__17525__auto__)){
return or__17525__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__17525__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__17525__auto__)){
return or__17525__auto__;
} else {
...
var G__46825 = o;
(G__46825[cljs.core.name.call(null,k)] = v);
...
while (G__46827__i < G__46827__a.length) {G__46827__a[G__46827__i] = arguments[G__46827__i + 0]; ++G__46827__i;}
  args = new cljs.core.IndexedSeq(G__46827__a,0);
} 
...
var n = (function (){var G__46830 = reagent.impl.component._STAR_current_component_STAR_;
if((G__46830 == null)){
return null;
} else {
return (G__46830["cljsName"])();
}
})();
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__18297__auto__ = (function reagent$impl$component$shallow_obj_to_map_$_iter__46835(s__46836){
return (new cljs.core.LazySeq(null,(function (){
var s__46836__$1 = s__46836;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__46836__$1);
if(temp__4425__auto__){
var s__46836__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__46836__$2)){
var c__18295__auto__ = cljs.core.chunk_first.call(null,s__46836__$2);
var size__18296__auto__ = cljs.core.count.call(null,c__18295__auto__);
var b__46838 = cljs.core.chunk_buffer.call(null,size__18296__auto__);
if((function (){var i__46837 = (0);
while(true){
if((i__46837 < size__18296__auto__)){
var k = cljs.core._nth.call(null,c__18295__auto__,i__46837);
cljs.core.chunk_append.call(null,b__46838,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k),(o[k])], null));

var G__46839 = (i__46837 + (1));
i__46837 = G__46839;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__46838),reagent$impl$component$shallow_obj_to_map_$_iter__46835.call(null,cljs.core.chunk_rest.call(null,s__46836__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__46838),null);
}
} else {
var k = cljs.core.first.call(null,s__46836__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k),(o[k])], null),reagent$impl$component$shallow_obj_to_map_$_iter__46835.call(null,cljs.core.rest.call(null,s__46836__$2)));
}
} else {
return null;
}
...
return iter__18297__auto__.call(null,cljs.core.js_keys.call(null,o));
})());
});
...
//# sourceMappingURL=component.js.map?rel=1452702581263