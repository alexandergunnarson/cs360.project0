...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__18123__auto__,writer__18124__auto__,opt__18125__auto__){
return cljs.core._write.call(null,writer__18124__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__17525__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__17525__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__17525__auto__)){
return or__17525__auto__;
} else {
...
var G__46843 = o;
(G__46843[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__46844__delegate = function (args){
...
while (G__46845__i < G__46845__a.length) {G__46845__a[G__46845__i] = arguments[G__46845__i + 0]; ++G__46845__i;}
  args = new cljs.core.IndexedSeq(G__46845__a,0);
} 
return G__46844__delegate.call(this,args);};
G__46844.cljs$lang$maxFixedArity = 0;
G__46844.cljs$lang$applyTo = (function (arglist__46846){
var args = cljs.core.seq(arglist__46846);
return G__46844__delegate(args);
});
...
var old_46847 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_46847))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_46847)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__17513__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__46850 = jsprops;
(G__46850["defaultValue"] = value);

(G__46850["onChange"] = ((function (G__46850,v,value,on_change){
return (function (p1__46848_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__46848_SHARP_);
});})(G__46850,v,value,on_change))
);
...
var vec__46852 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__46852,(0),null);
var id = cljs.core.nth.call(null,vec__46852,(1),null);
var class$ = cljs.core.nth.call(null,vec__46852,(2),null);
...
var temp__4427__auto__ = (function (){var G__46854 = cljs.core.meta.call(null,v);
if((G__46854 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__46854);
}
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__46856_46857 = v;
var G__46856_46858__$1 = (((G__46856_46857 == null))?null:reagent.impl.template.key_from_vec.call(null,G__46856_46857));
if((G__46856_46858__$1 == null)){
} else {
(jsprops["key"] = G__46856_46858__$1);
}
...
var p = (function (){var temp__4427__auto__ = (function (){var G__46861 = cljs.core.meta.call(null,argv);
if((G__46861 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__46861);
}
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__46862 = (((jsprops == null))?{}:jsprops);
(G__46862["key"] = key);
...
var n__18428__auto___46863 = a.length;
var i_46864 = (0);
while(true){
if((i_46864 < n__18428__auto___46863)){
(a[i_46864] = reagent.impl.template.as_element.call(null,(a[i_46864])));

var G__46865 = (i_46864 + (1));
i_46864 = G__46865;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__18428__auto___46866 = a.length;
var i_46867 = (0);
while(true){
if((i_46867 < n__18428__auto___46866)){
var val_46868 = (a[i_46867]);
if((cljs.core.vector_QMARK_.call(null,val_46868)) && ((reagent.impl.template.key_from_vec.call(null,val_46868) == null))){
(o["no-key"] = true);
} else {
}

(a[i_46867] = reagent.impl.template.as_element.call(null,val_46868));

var G__46869 = (i_46867 + (1));
i_46867 = G__46869;
continue;
} else {
}
...
var G__46871 = (cljs.core.count.call(null,argv) - first_child);
switch (G__46871) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__46871){
...
//# sourceMappingURL=template.js.map?rel=1452702581578