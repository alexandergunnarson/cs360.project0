...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__45147 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__45147,kvps);
} else {
return G__45147;
}
})());
...
var map__45150 = rec;
var map__45150__$1 = ((((!((map__45150 == null)))?((((map__45150.cljs$lang$protocol_mask$partition0$ & (64))) || (map__45150.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45150):map__45150);
var depth = cljs.core.get.call(null,map__45150__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__45150__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__45153 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__45153__$1 = (((G__45153 == null))?null:cljs.core.persistent_BANG_.call(null,G__45153));
if((G__45153__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__45153__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__45154){
var vec__45157 = p__45154;
var frame = cljs.core.nth.call(null,vec__45157,(0),null);
var frames = cljs.core.nthnext.call(null,vec__45157,(1));
...
var or__17525__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__45158 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__45158,kvps);
} else {
return G__45158;
}
})();
...
var recursion = cljs.core.get.call(null,map__45161__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__45161__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_45163 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_45163){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_45163,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_45163))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__45165){
var vec__45171 = p__45165;
var parent = cljs.core.nth.call(null,vec__45171,(0),null);
var frames = cljs.core.nthnext.call(null,vec__45171,(1));
...
var found = cljs.core.not_empty.call(null,(function (){var G__45172 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__45172);
} else {
return G__45172;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__45171,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__45171,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__45171,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__45171,parent,frames))
);
...
if(cljs.core.truth_((function (){var and__17513__auto__ = component_QMARK_;
...
var as_value = (function (){var G__45173 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__45173,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__45171,parent,frames){
return (function (p1__45164_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__45164_SHARP_]);
});})(G__45173,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__45171,parent,frames))
,G__45173);
} else {
return G__45173;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__45174 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__45174);
} else {
return G__45174;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__45175 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__45175,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__45175;
}
})());
...
var vec__45177 = spec;
var attr_key = cljs.core.nth.call(null,vec__45177,(0),null);
var opts = cljs.core.nth.call(null,vec__45177,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__45178){
var vec__45179 = p__45178;
var k = cljs.core.nth.call(null,vec__45179,(0),null);
var v = cljs.core.nth.call(null,vec__45179,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__45180){
var vec__45182 = p__45180;
var frame = cljs.core.nth.call(null,vec__45182,(0),null);
var frames = cljs.core.nthnext.call(null,vec__45182,(1));
return datascript.pull_api.expand_result.call(null,frames,datascript.pull_api.into_BANG_.call(null,new cljs.core.Keyword(null,"expand-kvps","expand-kvps",44141154).cljs$core$IFn$_invoke$arity$1(frame),(function (){var or__17525__auto__ = datascript.pull_api.single_frame_result.call(null,new cljs.core.Keyword("datascript.pull-api","expand-rev","datascript.pull-api/expand-rev",2143627459),frame);
if(cljs.core.truth_(or__17525__auto__)){
return or__17525__auto__;
} else {
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__45183){
var vec__45186 = p__45183;
var frame = cljs.core.nth.call(null,vec__45186,(0),null);
var frames = cljs.core.nthnext.call(null,vec__45186,(1));
...
var vec__45187 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__45187,(0),null);
var datoms = cljs.core.nth.call(null,vec__45187,(1),null);
...
var attr = cljs.core.get.call(null,map__45191__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__45191__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__45193 = recursion;
if(cljs.core.some_QMARK_.call(null,attr)){
return datascript.pull_api.push_recursion.call(null,G__45193,attr,eid);
} else {
return G__45193;
}
})();
...
var map__45196 = frame;
var map__45196__$1 = ((((!((map__45196 == null)))?((((map__45196.cljs$lang$protocol_mask$partition0$ & (64))) || (map__45196.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45196):map__45196);
var eid = cljs.core.get.call(null,map__45196__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__45196__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__17525__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__17525__auto__)){
return or__17525__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__45198){
while(true){
var vec__45200 = p__45198;
var frame = cljs.core.nth.call(null,vec__45200,(0),null);
var frames = cljs.core.nthnext.call(null,vec__45200,(1));
var temp__4423__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__4423__auto__){
var eids = temp__4423__auto__;
...
var G__45201 = db;
var G__45202 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__45201;
p__45198 = G__45202;
continue;
}
...
while(true){
var G__45207 = (((new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)).fqn:null);
switch (G__45207) {
case "expand":
var G__45212 = db;
var G__45213 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__45212;
frames = G__45213;
continue;
...
case "expand-rev":
var G__45214 = db;
var G__45215 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__45214;
frames = G__45215;
continue;
...
case "pattern":
var G__45216 = db;
var G__45217 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__45216;
frames = G__45217;
continue;
...
case "recursion":
var G__45218 = db;
var G__45219 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__45218;
frames = G__45219;
continue;
...
break;
case "done":
var vec__45208 = frames;
var f = cljs.core.nth.call(null,vec__45208,(0),null);
var remaining = cljs.core.nthnext.call(null,vec__45208,(1));
var result = (function (){var G__45209 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__45209);
} else {
return G__45209;
}
})();
...
var G__45220 = db;
var G__45221 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__45210 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__45210,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__45210;
}
})());
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__45222_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__45222_SHARP_);
})),eids);
...
//# sourceMappingURL=pull_api.js.map?rel=1452702578104