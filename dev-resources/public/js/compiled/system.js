...
document.write('<script>if (typeof goog != "undefined") { goog.require("alexandergunnarson.byu.project0.system"); } else { console.warn("ClojureScript could not load :main, did you forget to specify :asset-path?"); };</script>');